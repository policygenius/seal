...
describe MessageBuilder do
  ...
  context 'no pull requests' do
    ...
    it 'builds seal of approval message' do
      expect(message_builder.build).to eq(":happyseal: :happyseal: :happyseal:\n\nNo pull requests to review! :rainbow: :sunny: :metal: :tada:")
    end
